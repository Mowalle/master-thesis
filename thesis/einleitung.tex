...
Beispielsweise sind hier die \emph{Microsoft HoloLens} \parencite{Microsoft2018} als AR-HMD oder die \emph{HTC Vive} \parencite{HTCCorporation2018} als VR-HMD zu nennen.
...
Schon in der Vergangenheit wurde von Forschern AR eingesetzt, um räumliche Informationen in der Umgebung von Nutzern anzuzeigen, z.B. um die Navigation zwischen zwei Punkten zu augmentieren.
...
\begin{itemize}
    ...
    So wird der Umgebung genug Aufmerksamkeit geschenkt und der mentale Aufwand der Nutzung wird verringert \parencites{}{}.
...
MR-HMDs wie die HoloLens oder die \emph{Magic Leap One} \parencite{MagicLeap2018} verwenden Infrarotkameras, um Strukturen der Umgebung virtuell in Echzeit zu rekonstruieren.
