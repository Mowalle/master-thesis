...
\begin{table}[tbh]
    ...
    \begin{tabular}{@{}lcccc@{}}
        ...
        \rowcoloreven Attribute  & \checkmark & \checkmark & --- & \\
...
Zum Beispiel befindet sich in Google Maps eine Liste von Umgebungsfotos in derselben Leiste wie die Ortsattribute, wie in \autoref{sfig:gm_photos_1} zu sehen ist.
Wird die Liste angeklick, öffnet sich eine Großansicht der Fotos (siehe \autoref{sfig:gm_photos_2}).
...
\begin{figure}
	...
	\subref{sfig:gm_photos_1} Eine Fotoliste ist in die Ortsattribute integriert. %
	\subref{sfig:gm_photos_2} Detailsansicht der Fotos.}
	\label{fig:gm_photos}
\end{figure}
