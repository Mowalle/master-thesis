...
\begin{itemize}
    ...
    user\_14 meint, dass man \enquote{bei 3D [\dots] gefühlt in jeden Raum reingucken [muss].}
    ...
    user\_7 fühlte sich von der hohen Megamap eingeengt und sagt dazu, dass er \enquote{erst einmal da rausgehen und außen herum laufen [muss].}
    ...
    Für den konkreten Prototyp schlägt user\_3 vor, eine visuelle Line vom Positionsmarker zur aktuellen Position des Nutzers zu ziehen.
    ...
    Ein Nutzer zielte während des Ablaufens der Karte mit dem Controller immer auf den Raum, in dem er die höchste Zahl an Bällen gezählt hatte (user\_14).
    ...
    Z.B. bevorzugten user\_4 und user\_6 die 2D-Karte für die Richtungsschätzung, da diese Variante \enquote{gewohnter} sei.
\end{itemize}
...
\begin{figure}[h]
    \begin{subfigure}{0.5\linewidth}
        \centering
        \missingfigure{Layout Karte 3}
        \caption{}
        \label{sfig:map_3}
    \end{subfigure}%
    \begin{subfigure}{0.5\linewidth}
        \centering
        \missingfigure{Layout Karte 4}
        \caption{}
        \label{sfig:map_4}
    \end{subfigure}%
    ...
    \textcolor{green}{Grüner Pfeil}: Laborraum. %
    \textcolor{red}{Roter Pfeil}: Zielraum.}
...
user\_13 hat z.B. darüber nachgedacht, durch welche Türen er zum Ziel laufen muss.
...
Andere Probanden empfanden die Animation jedoch als \enquote{irritierend} (user\_14).
Ein Proband sagte, dass \enquote{die Animation [sich anfühlt] wie Herunterfallen} (user\_9).
Weitere Probanden verspürte während der Animation die VR-typische Motion Sickness (user\_0, user\_7).
...
Ein Vorschlag der Probanden war, die Höhe der Wände der Megamap zu verringern, sodass man bei der hohen Megamap weiterhin gut in die Räume hineinsehen kann (user\_11, user\_13).
...
Wie user\_3 und user\_7 richtig erkennen, gehört für eine explorative Kartenanwendung mehr dazu, als ein simples räumliches Verständnis von Richtungen.
