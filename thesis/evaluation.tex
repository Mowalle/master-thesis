...
\begin{figure}[h]
    ...
    \textbf{(\subref{sfig:user_setup_wall})} Danach mussten die Probanden für zwei Sekunden auf das Ziel an der Wand schauen.}
...
\begin{minipage}{0.3\linewidth}
    \centering
    \captionof{table}{Mittelwert $\mu$ und Standardabweichung $\sigma$ der Suchzeit über alle Karten je Kondition.}
...
\begin{minipage}{0.63\linewidth}
    \centering
    \includegraphics[width=\linewidth]{figures/analysis/searchtime_boxplot}
    \captionof{figure}{Boxplot der durchschnittlichen Suchzeiten (in Sekunden) über alle Karten je Kondition.}
...
\begin{figure}[h]
    \centering
    \includegraphics[trim={0cm, 0	.5cm, 1.5cm, 1.5cm}, clip, height=0.45\textheight]{figures/analysis/horizontal_offset}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\linewidth]{figures/analysis/horizontal_offset_per_map}
...
Die 2D-Variante ist für die Suche den beiden 3D-Megamaps mit überlegen.
...
Bei der Gestaltung der Kartenlayouts wurde darauf geachtet, dass der zwischen den verschiedenen Karten der Zielraum vom Labor aus in unterschiedlichen Richtungen gelegen ist.
