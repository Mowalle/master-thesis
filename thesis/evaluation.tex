...
\begin{figure}[h]
    ...
    \textbf{(\subref{sfig:user_setup_floor})} Der Proband muss sich zuerst auf das 'X' stellen. %
    \textbf{(\subref{sfig:user_setup_wall})} Danach muss der Proband für \SI{2}{\second} auf das Ziel an der Wand schauen.}
...
Die Probanden wurden durch an der Universität ausgehängte Flyer (siehe Anhang \autoref{appendix:flyer}), den Mailverteiler des Fachbereichs~3 und über die Arbeitsgruppe Human-Computer~Interaction rekrutiert.
