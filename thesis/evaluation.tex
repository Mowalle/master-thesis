...
% TODO: Zitate
Die Probanden äußerten, dass ihnen der Positionsmarker und die Säule sowohl im virtuellen Labor als auch auf der Karte für einen Bezug zwischen Megamap und Umgebung ausgereicht hat.
...
Ein Proband äußerte, dass \enquote{...}. % TODO: Zitat (Tim?)
Andere Probanden empfanden die Animation jedoch als \enquote{störend} (user\_?) und sagten, dass die Animation die Orientierung nehme (user\_?).
Ein Proband sagte, dass \enquote{die Animation [sich anfühlt] wie Herunterfallen} (user\_).
Ein weiterer Proband verspürte während der Animation die VR-typische Motion Sickness.
Es lässt sich daraus schließen, dass die Animation, wie sie hier implementiert wurde, nicht für einen räumlichen Bezug zwischen Megamap und Umgebung geeignet ist und sogar kontraproduktive Effekte aufweisen kann.
...
Ein Vorschlag der Probanden war, die Höhe der Wände der Megamap zu verringern, sodass man bei der hohen Megamap weiterhin gut in die Räume hineinsehen kann. %TODO: Zitat
