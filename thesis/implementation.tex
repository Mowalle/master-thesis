...
Als Alternative zu WRLD bietet sich das Mapbox SDK\footnote{\url{https://www.mapbox.com/}} an.
...
Dies kann z.B. mit der Software \emph{QGIS}\footnote{\url{https://qgis.org/en/site/}} umgesetzt werden.
Für diese Arbeit wurde zunächst die Ebene 5 des MZH an der Universität Bremen basierend auf dem Lageplan des Gebäudes\footnote{\url{https://www.uni-bremen.de/universitaet/campus/lageplan/gebaeude/building/116/}} in QGIS georeferenziert.
...
Für das Bild wurde direkt von OSM der entsprechende Ausschnitt der Uni exportiert und mit dem Programm \emph{OSM2World}\footnote{\url{http://osm2world.org/}} gerendert.
