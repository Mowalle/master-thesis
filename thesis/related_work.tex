...
\begin{figure}[h]
    \centering
    % TODO: Grafik sollte Reelle Umgebung <---> Virtuelle Umgebung sein (nicht VR).
    \includegraphics[width=\textwidth]{figures/rv_kontinuum_milgram.pdf}
